...
@WebServlet("/Anouncement_View.do")
public class Anouncement_ViewCon extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("/Anouncement_View.jsp").forward(request, response);
	}
