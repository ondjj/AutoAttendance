                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                               ...
                               성적정정신청내역 목록<br><br>
                                <form method="get" action="ObjectionListCon.do?type=3">
								<span>
														...
														<tbody>
															<c:forEach items="${ objList }" var="row" varStatus="loop">
																	<tr align="center">
																		...
																		<td><a href="ObjectionListCon.do?obj_num=${row.obj_num }&&obj_type=${row.obj_type}">성적 정정 신청</a></td>
																	</tr>
															</c:forEach>
														</tbody>	
													</c:otherwise>
