                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <form name="WriteFrm" action="./news_Write.do" method="post" enctype="multipart/form-data" onsubmit="return check(this)">
                                	<table>
                                		<tr>
                                			<th>작성자</th>
											<td><input type="text" name="n_writer"></td>
										<tr>
											<th class="w">제목</th>
											<td><input type="text" name="n_subject" size="78"></td>
										</tr>
										<tr>
											<th class="w">기사내용</th>
											<td><textarea rows="3" cols="80" name="n_content" style="resize: none;"></textarea>
										</tr>
										<tr>
											<th class="w">이미지 파일</th>
											<td><input type="file" name="img_ofile"></td>
										</tr>
										<tr>
